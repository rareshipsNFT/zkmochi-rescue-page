...
export function RescueMochi() {
  ...
  return (
    <Grid.Container gap={2} justify="center">
      ...
      <Grid xs={24} justify="center">
        <Spacer h={.5} />
        <Input {...bindings} name="count" placeholder="Number of zkMochi" crossOrigin={undefined} />
        <Spacer h={.5} />
        <pre>Cost: {cost[0] || 0} Steel / {cost[1] || 0} Wafer / {cost[2] || 0} Cells</pre>
      </Grid>
      <Grid xs={24} justify="center">
        <Button type="secondary" placeholder={undefined}>Rescue</Button>
      </Grid>
    </Grid.Container>
  )
  ...
  return (
    <>
      ...
      >
        <Input name="address" placeholder="address" crossOrigin={undefined} />
        <Input name="value" placeholder="value (ether)" crossOrigin={undefined} />
